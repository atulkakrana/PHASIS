...
manflags.add_argument('-coord', default='', type=str, help='concatenated file from '\
...
manflags.add_argument('-predfile', default='', type=str, help='concatenated file from ' \
...
autoflags.add_argument('-libs',  nargs='*', default=[], help='PARE or degradome libraries in '\
    ...
    ' names can be separated by a empty space. Flat file should have unique PARE seqeunces and '\
